...
public class AdminFillInfo extends AppCompatActivity {

    private RecyclerView recyclerView;
    FillMatchInfoAdapter adapter; // Create Object of the Adapter class
    Query mbase, mbase1;
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FillMatchInfoAdapter(options);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AdminFillInfo.this, Admin.class));
            }
        });
