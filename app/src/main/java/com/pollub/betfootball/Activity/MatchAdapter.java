...
public class MatchAdapter extends FirebaseRecyclerAdapter<

        Match, MatchAdapter.MatchViewholder> {
    ...
    onBindViewHolder(@NonNull MatchViewholder holder, int position, @NonNull Match model) {
                                                              ...
                                                              if (Objects.equals(model.getTeamOneID(), match.teamOneID) && Objects.equals(model.getTeamTwoID(), match.teamTwoID)) {
                                                                  ...
                                                                  holder.matchDay.setOnClickListener(new View.OnClickListener() {
                                                                      ...
                                                                      public void onClick(View v) {
                                                                          Intent myIntent = new Intent(AuthUI.getApplicationContext(), PlaceBet.class);
